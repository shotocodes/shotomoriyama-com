// components/ServiceModal/ServiceSettingsPanel.tsx
'use client';

import styles from './ServiceSettingsPanel.module.css';

interface ServiceSettingsPanelProps {
  shapeType: 'box' | 'pyramid';
  onShapeToggle: () => void;
    ...
    <div className={styles.settingsPanel}>
      ...
      <div className={styles.settingGroup}>
        ...
        >
          {shapeType === 'box' ? (
            <>
              <span className={styles.activeShape}>📦 Box</span>
              <span className={styles.separator}>⇄</span>
              <span className={styles.inactiveShape}>🔺 Pyramid</span>
            </>
          ) : (
            <>
              <span className={styles.inactiveShape}>📦 Box</span>
              <span className={styles.separator}>⇄</span>
              <span className={styles.activeShape}>🔺 Pyramid</span>
            </>
          )}
        </button>
