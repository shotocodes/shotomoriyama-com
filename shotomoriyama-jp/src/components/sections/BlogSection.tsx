...
const getCategoryColor = (category: string) => {
  const colors = {
    '開発': 'rgba(0, 102, 255, 0.9)',      // 青
    '技術': 'rgba(78, 205, 196, 0.9)',     // ターコイズ
    'デザイン': 'rgba(255, 107, 107, 0.9)', // 赤
    'ビジネス': 'rgba(255, 217, 61, 0.9)',  // 黄色
    'キャリア': 'rgba(168, 218, 220, 0.9)', // 水色
  };
  ...
  return (
    <div
      ...
      style={{
        ...
        marginLeft: '20px',
        marginRight: '20px',
        height: '250vh' // 200vh → 250vh (アニメーション分)
      }}
    >
              ...
              <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
                ...
                <div className="flex-1 min-w-0 w-full">
                  ...
                  <div style={{ marginBottom: '6rem' }}>
                    <p
                      className="text-lg lg:text-2xl text-text-secondary leading-relaxed font-light"
