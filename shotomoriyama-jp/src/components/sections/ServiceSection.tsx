...
import AnimatedText from '@/src/components/shared/AnimatedText';
import GridButton from '@/src/components/shared/GridButton';
import SpeedMeter from '@/src/components/shared/SpeedMeter';
import GridBackground from '@/src/components/shared/GridBackground';
                ...
                <div className="flex-1 min-w-0 w-full">
                  ...
                  <div className="flex flex-col lg:flex-row items-start justify-between mb-12 lg:mb-16 gap-6">
                    <div className="flex-1">
                      <p className="text-lg lg:text-2xl text-text-secondary leading-relaxed font-light">
                        企画・設計からデザイン、開発、運用まで<br />一貫してサポートします
                      </p>
                    </div>
                    {/* <div className="flex-shrink-0">
                      <Link href="#contact">
                        <button className="inline-flex items-center gap-2 px-6 lg:px-8 py-3 bg-gradient-to-r from-[#0066FF] to-[#A8DADC] text-white font-bold text-sm rounded-full shadow-lg hover:shadow-xl transition-shadow group whitespace-nowrap">
                          <span className="group-hover:hidden">サービス内容を見る</span>
                          <span className="hidden group-hover:inline">サービス内容を見る</span>
